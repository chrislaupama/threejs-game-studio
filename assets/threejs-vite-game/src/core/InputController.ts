...
export class InputController {
  ...
  private readonly onStickCaptureLost = () => {
    this.resetPointer();
  };
  ...
  private readonly onRestartClick = () => {
    this.restartPressed = true;
  };
  ...
  constructor(
    ...
    this.stick.addEventListener('lostpointercapture', this.onStickCaptureLost);
  ...
  dispose(): void {
    ...
    this.stick.removeEventListener('lostpointercapture', this.onStickCaptureLost);
